...
function validate()
{
    if(document.getElementById('myNostalgia').value=="" || document.getElementById('grayscale').value=="" || document.getElementById('lomo').value == "") {
        document.getElementById('error').innerHTML="Please select a filter";
        return false;
    }
    return true;
}
